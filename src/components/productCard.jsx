...
export default function ProductCard(props) {
    ...
    return (
        <Link to={`/productInfo/${props.product.productID}`} className="w-[300px] h-[400px] m-[50px] rounded-xl shadow-lg shadow-gray-500 hover:shadow-primary hover:border-gray-500 hover:border-[3px] transition-shadow duration-300 flex flex-col items-center gap-4 p-4 justify-center" >
